...
struct LongNumber
{
    ...
    void GetNumber(bool singBool = 1){
        if (!IsHasNumbers()) {
            cout << "0";
            return;
        }
    ...
    bool FindBiggerNumberWithoutSing(const LongNumber &other){     //return 1 if this >= other, return 0 if this < other
        /*if (sing > other.sing)
            return true;
        else if (sing < other.sing)
            return false;
    ...
    LongNumber operator+ (const LongNumber &other) {
        if (FindBiggerNumberWithoutSing(other)){
...
struct LongFruction : LongNumber
{
    ...
    LongNumber FindNSD(LongNumber A1, LongNumber A2){
        if (CompareNumber(A1, A2) && CompareNumber(A2, A1))
            ...
            LongNumber a2 = A2;
            LongNumber quotation = a2 ^ A1;
            A2 = A2 - A1 * quotation;
            if (A2.lengTop == 1 && A2.arrayOfTopNumbers[0] == 0)
                return A1;
            return FindNSD(A1, A2);
        }
    }
    ...
    void MakeShorter() {
        if (this->arrayOfTopNumbers[0] == 0 && this->lengTop == 1){
            return;
        }
        int n = sing;
        this->sing = 1;
        ...
        top.sing = 1;
        low.sing = 1;
        if(top.arrayOfTopNumbers[0] == 0 && low.arrayOfTopNumbers[0] == 0) {
            LongNumber ten("10");
            while (top.arrayOfTopNumbers[0] == 0 && low.arrayOfTopNumbers[0] == 0) {
                top = top / ten;
                low = low / ten;
            }
        }
...
/*
    ...
    switch (in) {
        case '+': cin >> str2; secondNumber.SetNumber(str2);
            firstNumber = firstNumber + secondNumber;break;
        case '-': cin >> str2; secondNumber.SetNumber(str2);
            firstNumber = firstNumber - secondNumber; break;
        case '*': cin >> str2; secondNumber.SetNumber(str2);
            firstNumber = firstNumber * secondNumber; break;
